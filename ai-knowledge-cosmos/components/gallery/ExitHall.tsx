...
export function ExitHall() {
  return (
    <section className="relative isolate flex h-svh w-screen shrink-0 items-end overflow-hidden bg-void px-[6vw] py-[10vh]">
      <p className="pointer-events-none absolute top-1/2 left-[-4vw] -translate-y-1/2 select-none font-serif text-[min(80vh,70vw)] leading-none text-acid/15">
        终
      </p>
      ...
      <div className="relative z-10 max-w-xl">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <Link href="/learn" className="cta-acid">
            展墙目录
          </Link>
